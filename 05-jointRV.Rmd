...
## Joint Distributions for Discrete RVs {#jointDis}
...
Table: (\#tab:5-marg-table2) Example Joint PMF of Study Time ($X$) and Grades ($Y$), with Marginal PMF of Study Time and Grades
...
## Joint, Marginal, Conditional Distributions for Continuous RVs {#jointCont}
...
## Covariance and Correlation {#covcorr}
...
## Common Multivariate Distributions {#commMultDist}
