...
##support
x<-0:3
## CDF for each value in the support. 
CDF<-c(1/8, 1/2, 7/8, 1)
...
There are several rules of thumbs that exist to guide as to how large $n$ should be and how small $np$ should be. According to the National Institute of Standards and Technology [(NIST)](https://www.itl.nist.gov/div898/handbook/pmc/section3/pmc331.htm), $n \geq 20$ and $p \leq 0.05$, or $n \geq 100$, and $np \leq 10$.
