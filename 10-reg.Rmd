...
respectively. Eqaution \@ref(eq:10-fitted) is called the **fitted line**. The line that was overlaid in the scatter plot for the toy example in Figure \@ref(fig:10-scatter) represents the fitted line. Equation \@ref(eq:10-fitted-model) is called the **estimated SLR model**.
