...
\textbf{Y=2} & 0.10 & 0.20 & 0.10 \\
\textbf{Y=3} & 0.15 & 0.05 & 0 \\
\end{longtable}
...
\section{Marginal Distributions for Discrete RVs}\label{marginal-distributions-for-discrete-rvs}

\section{Conditional Distributions for Discrete RVs}\label{conditional-distributions-for-discrete-rvs}
...
\section{Common Multivariate Distribtuions}\label{common-multivariate-distribtuions}
