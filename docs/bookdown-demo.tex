...
\emph{Thought question}: Compare equation \eqref{eq:5-jointCDF} with its univariate (one variable) counterpart in equation \eqref{eq:3-CDF}. Can you see the similarities and differences?
