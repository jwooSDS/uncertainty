...
\FunctionTok{plot}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{courses, df}\SpecialCharTok{$}\NormalTok{study, }\AttributeTok{xlab=}\StringTok{"\# of Courses"}\NormalTok{, }\AttributeTok{ylab=}\StringTok{"Study Time (Mins)"}\NormalTok{, }
     \AttributeTok{main=}\StringTok{"Scatterplot of Study Time against Number of Courses Taken"}\NormalTok{)}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-112-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-112-3.pdf}
