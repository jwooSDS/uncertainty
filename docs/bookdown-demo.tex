...
\subsubsection{Linear and Non Linear Transformations}\label{linear-and-non-linear-transformations}
...
\FunctionTok{mean}\NormalTok{(X) }\DocumentationTok{\#\#EX since fie is fair}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Concave and Convex Functions}\label{concave-and-convex-functions}
