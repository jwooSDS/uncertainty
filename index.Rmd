...
# Preface (Summer 2026 update) {-}

The examples in this preface are based on [OpenIntro Statistics](https://www.openintro.org/book/os/) (Diez, Ceytinka-Rundel, Barr), Chapter 9.4 and 9.5, which provide more background information. 
...
### Example 2: Job Application Callback Rates {-}
...
Practitioners of data science should be comfortable working with using base R and `tidyverse` functions. I highly encourage everyone to learn both of these:
...
If you find any issues (typos, formatting, etc), please [report them at my GitHub page](https://github.com/jwooSDS/uncertainty/issues). Please be as specific as you can, by specifying the section and paragraph where the issue is found.  
