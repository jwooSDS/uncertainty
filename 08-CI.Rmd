...
This module is based on [Introduction to Probability for Data Science](https://probability4datascience.com) (Chan), Chapter 9.1 and 9.2. Please note that I cover additional topics, and skip certain topics from the book. 
...
Note: the `qnorm()` function was introduced in a bit more detail in Section \@ref(RCont), so feel free to go back to review.
...
```{r 8-credit, fig.cap="Density Plot of Credit Limits", message=FALSE}
library(ISLR2)
