...
#### From Standard Normal to Other Normals
...
*Thought question*: Can you use the linearity of expectations to explain why $X$ has mean 0? Can you use properties of variance from Section \@ref(var-prop) to explain why $X$ has variance $\sigma^2$?
...
library(moments)
moments::skewness(Data$interest_rate)
moments::kurtosis(Data$interest_rate)
```
